...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section id="projects-hero" className="py-20 bg-gradient-to-br from-primary to-primary/90 text-primary-foreground">
      ...
      {/* Featured Projects */}
      <section id="projects-destacados" className="py-20">
        <div className="container mx-auto px-6">
      ...
      {/* All Projects Grid */}
      <section id="projects-otros" className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">
              Otros Proyectos
      ...
      {/* Stats Section */}
      <section id="projects-numeros" className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-6">
      ...
      {/* CTA Section */}
      <section id="projects-cta" className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
